...
import { authOptions } from './google-docs-read.data';

export const googleDocsReadConfig: NodeConfigType[] = [
	{
		name: 'auth_type',
	...
	},
	{
		name: 'placeholder',
		label: 'Placeholder',
		description: 'Select the Google Docs document to read from.',
	...
	},
	{
		...
		showWhen: { field: 'auth_type', value: 'google_manual' },
		validation: [{ field: 'file_id', label: 'File ID', type: 'string', required: true }],
	},
];
