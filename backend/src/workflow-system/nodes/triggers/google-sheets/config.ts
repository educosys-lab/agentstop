...
export const googleSheetsTriggerConfig: NodeConfigType[] = [
	{
		name: 'auth_type',
	...
	},
	{
		name: 'placeholder',
		label: 'Google Sheet',
		description: 'Select the Google Sheets document to monitor for changes.',
		...
		validation: [
			...
			{ field: 'file_id', label: 'File ID', type: 'string', required: true },
		],
	},
	{
		name: 'access_token',
